...
<body>
	<div>
		...
		<li><a href='<?php echo site_url('main/competitors')?>'>Competitors</a></li>
		<li><a href='<?php echo site_url('main/cards')?>'>Cards</a></li>
		<li><a href='<?php echo site_url('main/authorizations')?>'>Authorizations</a></li>
		<li><a href='<?php echo site_url('main/entrylogs')?>'>EntryLogs</a></li>
		<li><a href='<?php echo site_url('main/matches')?>'>Matches</a></li>
		<li><a href='<?php echo site_url('main/venues')?>'>Venues</a></li>
